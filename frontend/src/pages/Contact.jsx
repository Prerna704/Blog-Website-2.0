...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showToast("success", "Successfully sent message");
    ...
    <div className="min-h-screen bg-luxBg text-luxText">
      {toast.show && (
        <div className="fixed top-6 left-1/2 -translate-x-1/2 z-50">
          <div
            className={`px-5 py-3 rounded-lg border shadow-lg ${{
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="bg-luxSurface border border-luxBorder rounded-2xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label className="block text-sm font-medium text-luxHeading mb-2">Name</label>
                <input
                  type="text"
                  name="name"
                  value={formData.name}
              ...
              <div>
                <label className="block text-sm font-medium text-luxHeading mb-2">Email</label>
                <input
                  type="email"
                  name="email"
              ...
              <div>
                <label className="block text-sm font-medium text-luxHeading mb-2">Subject</label>
                <input
                  type="text"
                  name="subject"
              ...
              <div>
                <label className="block text-sm font-medium text-luxHeading mb-2">Message</label>
                <textarea
                  name="message"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full px-6 py-3 bg-luxAccent text-luxBg font-medium rounded-lg hover:opacity-90 transition shadow-lg shadow-emerald-500/20 disabled:opacity-60 disabled:cursor-not-allowed"
              >
